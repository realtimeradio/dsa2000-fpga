...
function pfb_fir_2p_2kpt_12i_18o_os2_core_config(this_block)
  ...
  this_block.setEntityName('pfb_fir_2p_2kpt_12i_18o_os2_core_ip_struct');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('pol_in0').width ~= 16*12);
      this_block.setError('Input data type for port "pol_in0" must have width=16*12.');
    end
    if (this_block.port('pol_in1').width ~= 16*12);
      this_block.setError('Input data type for port "pol_in1" must have width=16*12.');
    end
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('dsp/pfb_fir_2p_2kpt_12i_18o_os2_core_ip_struct.vhd');
