...
function fft_2p_2kc_18i_18o_core_config(this_block)
  ...
  this_block.setEntityName('fft_2p_2kc_18i_18o_core_ip_struct');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('pol_in0').width ~= 16*18);
      this_block.setError('Input data type for port "pol_in0" must have width=16*18.');
    end
    if (this_block.port('pol_in1').width ~= 16*18);
      this_block.setError('Input data type for port "pol_in1" must have width=16*18.');
    end
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('dsp/fft_2p_2kc_18i_18o_core_ip_struct.vhd');
