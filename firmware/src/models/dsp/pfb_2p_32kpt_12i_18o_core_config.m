...
function pfb_2p_32kpt_12i_18o_core_config(this_block)
  ...
  this_block.setEntityName('pfb_2p_32kpt_12i_18o_core_ip_struct');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('dsp/pfb_2p_32kpt_12i_18o_core_ip_struct.vhd');
