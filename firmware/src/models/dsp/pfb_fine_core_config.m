...
function pfb_fine_core_config(this_block)
  ...
  this_block.setEntityName('pfb_fine_core_ip_struct');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('pol_in0').width ~= 8*36);
      this_block.setError('Input data type for port "pol_in0" must have width=8*36.');
    end
    if (this_block.port('pol_in1').width ~= 8*36);
      this_block.setError('Input data type for port "pol_in1" must have width=8*36.');
    end
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('dsp/pfb_fine_core_ip_struct.vhd');
